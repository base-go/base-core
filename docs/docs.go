    ...
    "paths": {
            ...
            "get": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Bad Request",
                        "schema": {
                            "$ref": "#/definitions/companies.ErrorResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
        ...
        "/companies/all": {
            "get": {
                ...
                "description": "Get a list of all companies without pagination",
                "consumes": [
                    "application/json"
                ],
                "produces": [
                ...
                "summary": "List all companies without pagination",
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/companies.SuccessResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
