...
func NewMediaApiController(service *MediaService, storage *storage.ActiveStorage, logger logger.Logger) *MediaApiController {
...
func (c *MediaApiController) Routes(router *gin.RouterGroup) {
	// Main CRUD endpoints
...
// @Security ApiKeyAuth
// @Security BearerAuth
func (c *MediaApiController) Create(ctx *gin.Context) {
...
// @Security ApiKeyAuth
// @Security BearerAuth
func (c *MediaApiController) UpdateFile(ctx *gin.Context) {
...
// @Security ApiKeyAuth
// @Security BearerAuth
func (c *MediaApiController) RemoveFile(ctx *gin.Context) {
	id, err := strconv.ParseUint(ctx.Param("id"), 10, 32)
	if err != nil {
		ctx.JSON(http.StatusBadRequest, ErrorResponse{Error: "invalid id parameter"})
		return
...
// @Security ApiKeyAuth
// @Security BearerAuth
func (c *MediaApiController) Update(ctx *gin.Context) {
	id, err := strconv.ParseUint(ctx.Param("id"), 10, 32)
	if err != nil {
		ctx.JSON(http.StatusBadRequest, ErrorResponse{Error: "invalid id parameter"})
		return
...
// @Security ApiKeyAuth
// @Security BearerAuth
func (c *MediaApiController) Delete(ctx *gin.Context) {
	id, err := strconv.ParseUint(ctx.Param("id"), 10, 32)
	if err != nil {
		ctx.JSON(http.StatusBadRequest, ErrorResponse{Error: "invalid id parameter"})
		return
...
// @Security ApiKeyAuth
// @Security BearerAuth
func (c *MediaApiController) Get(ctx *gin.Context) {
	id, err := strconv.ParseUint(ctx.Param("id"), 10, 32)
	if err != nil {
		ctx.JSON(http.StatusBadRequest, ErrorResponse{Error: "invalid id parameter"})
		return
...
// @Security ApiKeyAuth
// @Security BearerAuth
func (c *MediaApiController) List(ctx *gin.Context) {
	page := 1
	limit := 10
...
// @Security ApiKeyAuth
// @Security BearerAuth
func (c *MediaApiController) ListAll(ctx *gin.Context) {
