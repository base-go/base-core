...
func (bc *Controller) RespondSuccess(c *router.Context, data any, message ...string) {
...
func (bc *Controller) RespondCreated(c *router.Context, data any, message ...string) {
	response := types.SuccessResponse{
		Success: true,
		Data:    data,
	}
...
func (bc *Controller) RespondError(c *router.Context, statusCode int, message string, details ...any) {
...
func (bc *Controller) RespondForbidden(c *router.Context, message ...string) {
	msg := "Forbidden"
	if len(message) > 0 {
		msg = message[0]
	}
...
func (bc *Controller) GetPaginationParams(c *router.Context) (page int, limit int) {
...
func (bc *Controller) GetIDParam(c *router.Context) (uint, error) {
	idStr := c.Param("id")
